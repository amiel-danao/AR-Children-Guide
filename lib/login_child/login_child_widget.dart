...
import 'login_child_model.dart';
export 'login_child_model.dart';

class LoginChildWidget extends StatefulWidget {
  const LoginChildWidget({Key? key}) : super(key: key);

  @override
  _LoginChildWidgetState createState() => _LoginChildWidgetState();
}

class _LoginChildWidgetState extends State<LoginChildWidget> {
  late LoginChildModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginChildModel());
  ...
  Future<void> login() async {
    ...
    String result = await Auth().signInWithEmailAndPassword(
        email: _model.emailAddressController.text, password: _model.passwordController.text);
    if (result == "Success") {
